      ...
      <div className="flex items-center gap-3 p-4 bg-[#1E3A5F]/5 border border-[#1E3A5F]/10 rounded-xl">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Notifications are generated automatically when payments are
            confirmed, classes are booked or cancelled, payouts are processed,
            and refund requests are submitted.
          </p>
        </div>
