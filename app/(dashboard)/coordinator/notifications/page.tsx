            ...
            {filtered.map((notif) => {
              ...
              return (
                ...
                >
                  {/* Icon */}
                  <div
                    className={`w-9 h-9 rounded-xl ${cfg.iconBg} flex items-center justify-center flex-shrink-0 mt-0.5`}
                  >
      ...
      <div className="flex items-center gap-3 p-4 bg-[#1E3A5F]/5 border border-[#1E3A5F]/10 rounded-xl">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            You'll receive notifications when students are assigned to your bucket,
            classes are booked or cancelled, payments need confirmation, and
            onboarding milestones are reached.
          </p>
        </div>
