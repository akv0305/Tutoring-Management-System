...
import {
  Download, Eye, X, Calendar, Clock, User, BookOpen, Star,
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[85vh] flex flex-col">
        ...
        <div className="overflow-y-auto flex-1 p-5 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start justify-between py-2 border-b border-gray-50">
              ...
              <span className="text-sm text-[#1E293B] text-right max-w-[200px]">
                {cls.topic}
              </span>
            </div>
            ...
            <div className="py-2 border-b border-gray-50">
              <span className="text-sm text-gray-500 flex items-center gap-2 mb-1.5">
                <MessageSquare className="w-4 h-4" />
                Session Notes (Lesson Details)
              </span>
              {cls.sessionNotes ? (
                <div className="bg-gray-50 rounded-lg p-3 text-sm text-[#1E293B] whitespace-pre-wrap">
                  {cls.sessionNotes}
                </div>
              ) : (
                <p className="text-xs text-gray-400 italic">
                  No session notes added for this class.
                </p>
              )}
            </div>
        ...
        <div className="flex items-center justify-end p-5 border-t border-gray-100 shrink-0">
          <button
            onClick={onClose}
    ...
    },
    {
      ...
      render: (r: HistoryRow) => (
        <button
          ...
          className="inline-flex items-center gap-1 p-1.5 rounded-md text-[#0D9488] hover:bg-teal-50 transition-colors"
