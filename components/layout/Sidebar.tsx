...
export function Sidebar({ role, navItems, userName, userEmail, isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 h-full flex flex-col z-50 transition-transform duration-300 ease-in-out",
          "w-[260px]",
